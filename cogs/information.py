    ...
    async def help(self, ctx, state: str = None):
        ...
        # если не назначено
            ...
            emb.add_field(name='7. Питомцы',
                          value='Тоже кейсы , но из них можно выбить питомцев с помощью которых можно получить очень'
                                ' классные эффекты , выбить питомцев довольно сложно и дорого, '
                                'но я думаю это того стоит. Подробнее - "/help питомцы".')
        ...
        # Питомцы
            ...
            emb.add_field(name='Пример:',
                          value='Вы сыграли в казино на 50.000 SH, победили, вам прибавляется на баланс 50.000 SH '
                                'которые вы выйграли и сверху 3.500 SH за счет того что у вас данный питомец.',
                          inline=False)
            emb.add_field(name='2."Лиса"',
                          value='Данный питомец прибавляет 7% SH от времени которое вы находились в голосовом канале.',
                          inline=False)
            emb.add_field(name='Пример:',
                          value='Вы просидели в голосовом канале 4 часа, после выхода вам начислятся 4.800 SH, за счет'
                                ' того что у вас данный питомец , вам сверху прибавится 336 SH.',
                          inline=False)
            emb.add_field(name='3."Собака"', value='Данный питомец возвращает вам 5 % от проигрыша в казино.',
                          inline=False)
            emb.add_field(name='Пример:',
                          value='Вы поставили в казино 5000 SH и проиграли , за счет того что у вас данный питомец,'
                                ' вам вернется 250 SH. :exclamation: Если ставка менее 100 SH возврата средств не '
                                'будет :exclamation: .',
                          inline=False)
            ...
            emb.add_field(name=':exclamation: Важно :exclamation:',
                          value='Если у вас несколько питомцев , выбран может быть только один , выбрать питомца'
                                ' можно командой "/selectpet".',
                          inline=False)
